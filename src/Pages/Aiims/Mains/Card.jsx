...
export default function MainsCard() {
  ...
  const updateView = async (sno) => {
    try {
      const response = await axios.post(
        `${Endpoint}admin/get/A_ViewMainsById.php`,
        {
          adminId: email,
          id: sno,
        }
      ...
      setViewData(Datas);
      setName(Datas.mains_name);
      setDescription(Datas.mains_desc);
      setInstruction(Datas.mains_instruction);
  ...
  const handleClick = async () => {
    try {
      await axios.post(
        `${Endpoint}admin/put/A_updateMains.php`,
        {
          admin_id: email,
          id:sno,
          name:name,
