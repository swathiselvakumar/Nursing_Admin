...
export default function AddMains() {
...
//  const {sno}=useParams()
  ...
  const BreadcrumbItems = [
    ...
    { label: "Add Mains", path: PATH.ADDMAINS},
  ...
  const SendApi = async () => {
    try {
      const response = await axios.post(
        `http://localhost/Nursing/controllers/api/admin/post/A_InsertMainsQuestion.php`,
        Data
      ); 
      
      Navigate(`/mainsinstitution/${sno}`);
    } catch (error) {
